 ...
 *
 */
const { getEnv, unpackLDAPConfig, unpackRedisConfig } = require('kth-node-configuration')
...
const devSessionKey = 'menu-web.sid'
...
module.exports = {
  ...
  // Cortina
  blockApi: {
    blockUrl: getEnv('CM_HOST_URL', 'https://www-r.referens.sys.kth.se/cm/') // Block API base URL
  },
